...
class CouponSwapRepresentation:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "booking_family": self.booking_family,
        }
...
class OptionBundleRepresentation:
    ...
    component_kind_for_external_id: str = "option_leg"
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "component_kind_for_external_id": self.component_kind_for_external_id,
        }
    ...
    def from_dict(cls, data: dict[str, Any]) -> "OptionBundleRepresentation":
        return cls(
            ...
            component_kind_for_external_id=data.get("component_kind_for_external_id", "option_leg"),
        )
