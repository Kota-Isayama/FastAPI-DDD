    ...
    for event in schedule.events:
        ...
        if view_kind == "coupon_swap":
            ...
            out.append(CashflowRecord(
                ...
                metadata={"underlying": contract.underlying, "component_key": f"period_{event.index}_coupon"},
            ))
        else:
            ...
            out.append(CashflowRecord(
                ...
                payment_date=event.settlement_date.isoformat(),
                metadata={"component_key": f"period_{event.index}_call"},
            ))
            out.append(CashflowRecord(
                ...
                payment_date=event.settlement_date.isoformat(),
                metadata={"component_key": f"period_{event.index}_put"},
            ))
    return out
    ...
    for event in schedule.events:
        ...
        if view_kind == "coupon_swap":
            ...
            out.append(CashflowRecord(
                ...
                amount_description=amount_desc,
                payment_date=event.settlement_date.isoformat(),
                metadata={"component_key": f"period_{event.index}_coupon"},
            ))
        else:
