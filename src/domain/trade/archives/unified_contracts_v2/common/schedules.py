...
class EventSchedule:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "EventSchedule":
        return cls(events=tuple(Event.from_dict(x) for x in data["events"]), role=data.get("role", "generic"))
...
class ObservationWindow:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "ObservationWindow":
        ...
        return cls(
            ...
            start_date=None if s is None else date.fromisoformat(s),
            end_date=None if e is None else date.fromisoformat(e),
